...
/**
 * Create mock panel props for Storybook stories
 */
export const createMockPanelProps = (overrides?: {
  contextOverrides?: Partial<PanelContextValue>;
  actionsOverrides?: Partial<PanelActions>;
}): PanelComponentProps => ({
  context: createMockContext(overrides?.contextOverrides),
  actions: createMockActions(overrides?.actionsOverrides),
